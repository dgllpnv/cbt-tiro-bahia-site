...
// =====================================================
// NewHabitualityDialog — modal de lancamento retroativo de habitualidade
//
// Extraido da antiga pagina HabitualityManualPage (agora so o corpo do
// formulario). O associado ja vem selecionado pelo pai; o modal so cuida
// da data/tipo/linhas de calibre-arma-tiros e chama POST /habituality/manual.
// =====================================================
...
interface NewHabitualityDialogProps {
  open: boolean;
...
const NewHabitualityDialog = ({ open, onOpenChange, memberId, memberName, onCreated }: NewHabitualityDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-military">Nova habitualidade{memberName ? ` — ${memberName}` : ''}</DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!canSubmit}
            className="bg-cbt-orange hover:bg-cbt-orange/90 text-foreground font-tactical font-bold min-w-[160px]"
          >
            {saving ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Salvar habitualidade'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
...
export default NewHabitualityDialog;
